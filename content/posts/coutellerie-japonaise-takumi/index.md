---
title: L'art de la coutellerie japonaise avec Takumi
subtitle: Rencontre avec un coutelier à quelques kilomètres de chez moi
seotitle: "L'art de la coutellerie japonaise avec Takumi — Grégory Mignard"
date: 2026-07-05 14:00:00 +0200
slug: "coutellerie-japonaise-takumi"
categories:
- rencontres
tags: ["Coutellerie", "Couteau japonais", "Takumi", "Artisanat", "Japon", "Brest", "Bretagne", "Rencontre"]
description: "Rencontre avec Takumi, coutelier japonais installé près de Brest, qui transforme des lames brutes forgées au Japon en couteaux façonnés à la main."
resources:
- src: "cover.webp"
  name: "cover"
- src: "*.webp"
...
{{< photoset always="2" >}}
{{< photo src="Taku_1.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{< photo src="Taku_10.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{</ photoset >}}

{{< photoset max="3" >}}
{{< photo src="Taku_2.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{< photo src="Taku_11.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{< photo src="Taku_13.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{</ photoset >}}

{{< photoset always="2" >}}
{{< photo src="Taku_15.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{< photo src="cover" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{</ photoset >}}
...
{{< photo src="Taku_16.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}

{{< photoset always="2" >}}
{{< photo src="Taku_17.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{< photo src="Taku_9.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{</ photoset >}}

{{< photoset always="2" >}}
{{< photo src="Taku_8.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{< photo src="Taku_4.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{</ photoset >}}

{{< photo src="Taku_6.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}

{{< photoset max="3" >}}
{{< photo src="Taku_7.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{< photo src="Taku_12.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{< photo src="Taku_3.webp" alt="L'art de la coutellerie japonaise avec Takumi" >}}
{{</ photoset >}}
