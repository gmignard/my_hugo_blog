...
categories:
- aventures
tags: ["Meneham", "Kerlouan", "Retraite", "Lenteur", "GR34", "Bloc", "Escalade", "Surf", "Bretagne", "Mindful Journey"]
description: "Récit de quatre jours passés à Meneham avec Jeremy. Une retraite entre surf, marche sur le GR34, escalade de bloc et l'art de ne rien faire."
resources:
- src: "cover.webp"
  name: "cover"
- src: "*.webp"
...
L'idée d'une retraite avec Jeremy trainait depuis un moment. On en parlait régulièrement, sans jamais trouver le bon moment. Quand [le site de Meneham](https://www.meneham.bzh) nous a proposé de venir vivre une expérience lente et immersive, ça a fait tilt. C'était l'occasion parfaite de transformer ce projet en quelque chose de concret. Carte blanche pour créer, documenter, vivre le lieu à notre façon. La seule consigne qu'on s'est donnée : prendre le temps.
...
{{< photo src="day1_1.webp" alt="Le tempo de Meneham">}}

{{< photoset max="3" >}}
  {{< photo src="day1_2.webp" alt="Le tempo de Meneham" >}}
  {{< photo src="day1_3.webp" alt="Le tempo de Meneham" >}}
...
Enfin, un dernier repas au [Bistrot des Légendes](https://www.bistrotdeslegendes-meneham.com) pour fermer ce chapitre.
