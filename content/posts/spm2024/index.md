---
title: "Carnet de voyage à Saint-Pierre-et-Miquelon"
subtitle: "Quand un tournage devient une aventure"
seotitle: "Carnet de voyage à Saint-Pierre-et-Miquelon — Grégory Mignard"
date: 2026-02-05 11:30:12 +0100
slug: "spm2024"
categories:
- aventures
- productions
...
description: "Récit d'un tournage à Saint-Pierre-et-Miquelon. Entre travail, rencontres authentiques et nature sauvage, un voyage qui a marqué mon parcours."
resources:
- src: "cover.webp"
  name: "cover"
- src: "*.webp"
...
Je me rappelle encore de l'appel de [Jeremy](https://jeremyjanin.com). Il venait lui-même de recevoir un coup de fil de la part d'une agence qui cherchait un prestataire vidéo pour répondre à un besoin de réalisation d'un film pour Saint-Pierre-et-Miquelon. Cette agence a pensé à [Captain Yvon](https://captainyvon.fr) pour ce projet et forcément, quand j'ai Jeremy au bout du fil, je sens énormément d'excitation dans sa voix, excitation que je partagerai très vite avec lui quand il aura fini de m'expliquer le projet.  
...
{{< photoset always="2" >}}
  {{< photo src="ASP_1.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="ASP_2.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}
...
{{< photo src="waltermitty.webp" alt="Walter Mitty" >}}
...
{{< photoset max="3" >}}
  {{< photo src="sp1.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="sp2.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="sp3.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}

{{< photo src="sp4.webp" alt="SPM" >}}
...
{{< photoset max="3" >}}
  {{< photo src="sp5.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="sp6.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="sp7.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}
...
{{< photoset always="2" >}}
  {{< photo src="miquelon1.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="miquelon2.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}

{{< photo src="miquelon3.webp" alt="SPM" >}}

{{< photo src="miquelon4.webp" alt="SPM" >}}
...
{{< photo src="ferry1.webp" alt="SPM" >}}

{{< photoset always="2" >}}
  {{< photo src="ferry2.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="ferry3.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}

Retour à Saint-Pierre, par le ferry cette fois, pour la suite de notre tournage. Nous continuons nos rencontres et aventures, comme cette rando avec [Gilles](https://www.escapade-insulaire.com/votre-guide) sur les hauteurs de l'île. Saint-Pierre n'est pas aussi grand que Miquelon, mais je dirais qu'il n'y a environ qu'un quart de la superficie qui est urbanisé, le reste, c'est que de la nature sauvage. Donc être en ville, faire ses courses, puis en moins de 5 minutes se retrouver seuls au monde, c'est une sensation assez folle que nous retrouverons très souvent.

{{< photo src="gille1.webp" alt="SPM" >}}

{{< photoset always="2" >}}
  {{< photo src="gille2.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="gille3.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}

{{< photo src="gille4.webp" alt="SPM" >}}

{{< photoset max="3" >}}
  {{< photo src="ilemarin1.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="ilemarin2.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="ilemarin3.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}

{{< photo src="ilemarin4.webp" alt="SPM" >}}
...
{{< photo src="phoque.webp" alt="SPM" >}}

{{< photoset always="2" >}}
  {{< photo src="langlade1.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="cheval.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}

{{< photo src="langlade3.webp" alt="SPM" >}}

{{< photo src="langlade2.webp" alt="SPM" >}}

{{< photoset always="2" >}}
  {{< photo src="langlade4.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="jeremy.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}

{{< photoset always="2" >}}
  {{< photo src="panneau1.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
  {{< photo src="panneau2.webp" alt="Carnet de voyage à Saint-Pierre-et-Miquelon" >}}
{{</ photoset >}}
...
<div>{{< youtube QBtNp4RaeRU >}}</div>

Et voilà, voici un aperçu de ces quelques notes que je suis content de partager aujourd'hui. Il y aurait encore beaucoup à dire, mais un autre article arrive et pour prolonger l'aventure, je vous invite à (ré)écouter [l'épisode de podcast](https://slowisbeautiful.substack.com/p/saint-pierre-et-miquelon-un-an-apres) que nous avons consacré à Saint-Pierre-et-Miquelon.